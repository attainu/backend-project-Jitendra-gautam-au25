...
cloudinary.config({
    cloud_name: 'dwkogp9tl',
    api_key: 712229671649382,
    api_secret: "3sFp0NV7xKlyWVYIwtQ_M9MxS2g"
});
...
router.post("/login", passport.authenticate("local", {
    ...
    failureFlash: true,
    successFlash: 'Welcome to J&N Book Store!'
}), function (req, res) {
    ...
    req.flash("success", "Welcome to J&N STORE!! ");
});
    ...
    async.waterfall([
        ...
        function (user, done) {
            var smtpTransport = nodemailer.createTransport({
                service: 'Gmail',
                auth: {
                    user: 'reachjitendra27@gmail.com',
                    pass: process.env.GMAILPW
                }
            });
            var mailOptions = {
