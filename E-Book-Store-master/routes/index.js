...
router.post("/contact", function (req, res) {
    ...
    if (contact) {
        const msg = {
            to: contact.email,
            from: 'reachjitendra@gmail.com',
            subject: 'E-Book-Store Support',
            text: 'You tried to contact us...',
            html: '<h1>Your Account Info.... </h1>' +
                '<br>' +
                '<b>Customer Name: </b>' + contact.name +
                '<br>' +
                '<b>Customer Email: </b>' + contact.email +
                '<br>' +
                '<b>Customer Mobile: </b>' + contact.mobile +
                '<br>' +
                '<b>Customer concern: </b>' + contact.message +
